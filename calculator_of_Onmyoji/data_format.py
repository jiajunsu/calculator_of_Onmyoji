...
MITAMA_GROWTH = {u"攻击加成": {u"最小成长值":2.4,  u"平均成长值":2.7,  u"最大成长值":3.0,    u"副属性最大值":26,  u"主属性":55},
                 u"生命加成": {u"最小成长值":2.4,  u"平均成长值":2.7,  u"最大成长值":3.0,    u"副属性最大值":26,  u"主属性":55},
                 u"防御加成": {u"最小成长值":2.4,  u"平均成长值":2.7,  u"最大成长值":3.0,    u"副属性最大值":26,  u"主属性":55},
                 u"效果命中": {u"最小成长值":3.2,  u"平均成长值":3.6,  u"最大成长值":4.0,    u"副属性最大值":32,  u"主属性":55},
                 u"效果抵抗": {u"最小成长值":3.2,  u"平均成长值":3.6,  u"最大成长值":4.0,    u"副属性最大值":32,  u"主属性":55},
                 u"暴击":    {u"最小成长值":2.4,  u"平均成长值":2.7,   u"最大成长值":3.0,   u"副属性最大值":26,  u"主属性":55},
                 u"暴击伤害": {u"最小成长值":3.2,  u"平均成长值":3.6,   u"最大成长值":4.0,   u"副属性最大值":24,  u"主属性":89},
                 u"速度":    {u"最小成长值":2.4,  u"平均成长值":2.7,   u"最大成长值":3.0,   u"副属性最大值":18,  u"主属性":57},
                 u"攻击":    {u"最小成长值":21.6, u"平均成长值":24.3,  u"最大成长值":27,    u"副属性最大值":162, u"主属性":486},
                 u"防御":    {u"最小成长值":4,    u"平均成长值":4.5,   u"最大成长值":5.0,   u"副属性最大值":30,  u"主属性":104},
                 u"生命":    {u"最小成长值":91.2, u"平均成长值":102.6, u"最大成长值":114.0, u"副属性最大值":684, u"主属性":2052},
                 }
